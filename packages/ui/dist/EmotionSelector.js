  ...
  return _jsxs('button', {
    ...
    children: [
      ...
      isSelected &&
        _jsx('div', {
          className:
            'absolute -top-0.5 -right-0.5 w-3 h-3 bg-blue-500 rounded-full border border-white',
        }),
    ],
  });
}
  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsx('div', {
        ...
        children: Object.keys(EMOTIONS).map(emotionKey => {
          ...
          return _jsxs(
            'div',
            {
              ...
              children: [
                _jsx('div', {
                  className:
                    'text-xs font-medium text-gray-700 text-center mb-1',
                  children: config.name,
                }),
                _jsx('div', {
                  className: 'flex flex-col space-y-1',
                  children: INTENSITY_LEVELS.map(intensity =>
                    _jsx(
                      EmotionCircle,
                      {
                        emotion: emotion,
        ...
        _jsx('div', {
          ...
          children: _jsxs('p', {
            ...
            children: [
              ...
              ' ',
              getEmotionConfig(selectedEmotion).name,
              ' (\uAC15\uB3C4: ',
              selectedIntensity,
              ')',
            ],
